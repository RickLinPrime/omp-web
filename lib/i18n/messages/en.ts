...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.commandGuidedGoal": "Interview you in chat, then set up goal mode",
    "chat.commandPlan": "Toggle plan mode (agent plans before executing)",
    "chat.commandVibe": "Toggle vibe mode (read-only toolset)",
    "chat.commandClear": "Clear the conversation context in place, keeping the session",
    "chat.commandRetry": "Retry the last failed agent turn",
    "chat.commandQueue": "Queue a message for after the agent yields",
    "chat.commandBtw": "Ask an ephemeral side question using the current session context",
    "chat.commandBranch": "Fork a new session from the N-th previous user message",
    "chat.commandTree": "Open the session tree (rollback)",
    "chat.commandNew": "Start a new session",
    "chat.commandDrop": "Delete the current session and start a new one",
    "chat.commandHotkeys": "Show keyboard shortcuts",
    ...
    "i18n.rollbackTitle": "Rollback to a previous message",
    "i18n.rollbackSearch": "Type to filter previous messages…",
    "i18n.noRollbackEntries": "No messages to roll back to yet",
    "i18n.rollbackCurrent": "current",
    "i18n.rollbackHint": "↑/↓ select · Enter rollback · Esc close",
    "i18n.source": "Source",
