...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.commandGuidedGoal": "在聊天中访谈你,然后建立目标模式",
    "chat.commandPlan": "切换计划模式(先计划后执行)",
    "chat.commandVibe": "切换 Vibe 模式(只读工具集)",
    "chat.commandClear": "原地清空对话上下文,保留会话",
    "chat.commandRetry": "重试上一次失败的回合",
    "chat.commandQueue": "把消息排到当前回合结束后发送",
    "chat.commandBtw": "用当前会话上下文问一个临时侧边问题",
    "chat.commandBranch": "从倒数第 N 条用户消息分叉新会话",
    "chat.commandTree": "打开会话树(回退)",
    "chat.commandNew": "新建会话",
    "chat.commandDrop": "删除当前会话并新建",
    "chat.commandHotkeys": "显示键盘快捷键",
    ...
    "i18n.rollbackTitle": "回退到过往输入",
    "i18n.rollbackSearch": "输入以筛选过往消息…",
    "i18n.noRollbackEntries": "暂无可回退的消息",
    "i18n.rollbackCurrent": "当前",
    "i18n.rollbackHint": "↑/↓ 选择 · Enter 回退 · Esc 关闭",
    "i18n.source": "源代码",
    "i18n.preview": "预览",
    "i18n.diff": "Diff",
