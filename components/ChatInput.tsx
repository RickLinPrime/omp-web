...
const BUILTIN_SLASH_COMMANDS: LocalBuiltinSlashCommand[] = [
  ...
  { name: "guided-goal", descriptionKey: "chat.commandGuidedGoal", source: "builtin" },
  { name: "plan", descriptionKey: "chat.commandPlan", source: "builtin" },
  { name: "vibe", descriptionKey: "chat.commandVibe", source: "builtin" },
  { name: "clear", descriptionKey: "chat.commandClear", source: "builtin" },
  { name: "retry", descriptionKey: "chat.commandRetry", source: "builtin" },
  { name: "queue", descriptionKey: "chat.commandQueue", source: "builtin" },
  { name: "btw", descriptionKey: "chat.commandBtw", source: "builtin" },
  { name: "branch", descriptionKey: "chat.commandBranch", source: "builtin" },
  { name: "tree", descriptionKey: "chat.commandTree", source: "builtin" },
  { name: "new", descriptionKey: "chat.commandNew", source: "builtin" },
  { name: "drop", descriptionKey: "chat.commandDrop", source: "builtin" },
  { name: "hotkeys", descriptionKey: "chat.commandHotkeys", source: "builtin" },
